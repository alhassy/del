...
;; error: Key sequence s-a r starts with non-prefix key s-a

;; (bind-key "s-a c" #'amethyst/cycle-layout)
;; error: Key sequence s-a c starts with non-prefix key s-a


;; Error (use-package): auto-package-update/:config: Symbol’s function definition is void: quelpa-read-cache
;; Error (use-package): diminish/:config: Symbol’s value as variable is void: org-indent-mode
;; Warning (initialization): An error occurred while loading ‘/Users/musa/.emacs.d/init.el’:


;; rror (use-package): auto-package-update/:config: Symbol’s function definition is void: quelpa-read-cache
;; Error (use-package): diminish/:config: Symbol’s value as variable is void: org-indent-mode
;; Error (use-package): Failed to parse package hydra-posframe: use-package: Unrecognized keyword: :quelpa
;; Warning (initialization): An error occurred while loading ‘/Users/musa/.emacs.d/init.el’:
;; 
;; Symbol's value as variable is void: magit-repository-directories
;;
